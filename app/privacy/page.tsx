      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <div className="space-y-8 text-black dark:text-white">
            <section>
              <h2 className="text-2xl font-bold text-black dark:text-white mb-4">1. {t('privacy.section1Title')}</h2>
              <p className="mb-4">
            ...
            <section>
              <h2 className="text-2xl font-bold text-black dark:text-white mb-4">2. {t('privacy.section2Title')}</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold text-black dark:text-white mb-4">3. {t('privacy.section3Title')}</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-bold text-black dark:text-white mb-4">4. {t('privacy.section4Title')}</h2>
              <p className="mb-4">
            ...
            <section>
              <h2 className="text-2xl font-bold text-black dark:text-white mb-4">5. {t('privacy.section5Title')}</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-bold text-black dark:text-white mb-4">6. {t('privacy.section6Title')}</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold text-black dark:text-white mb-4">7. {t('privacy.section7Title')}</h2>
              <p>
                {t('privacy.section7Text')}
              </p>
              <p className="mt-4">
                <strong className="text-black dark:text-white">E-posta:</strong> meaculpadesigns@gmail.com<br />
                <strong className="text-black dark:text-white">Instagram:</strong> @meaculpadesigns
              </p>
            </section>
