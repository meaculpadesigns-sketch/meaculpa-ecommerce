  ...
  return (
    <div className="min-h-screen py-20 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-black dark:text-white mb-2">Kullanıcı Yönetimi</h1>
          <p className="text-black dark:text-white">Kayıtlı kullanıcıları görüntüleyin ve kupon oluşturun</p>
        </div>

        {/* Stats */}
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
          <div className="glass rounded-xl p-6">
            <p className="text-black dark:text-white text-sm mb-1">Toplam Kullanıcı</p>
            <p className="text-black dark:text-white text-3xl font-bold">{users.length}</p>
          </div>
          <div className="glass rounded-xl p-6">
            <p className="text-black dark:text-white text-sm mb-1">Admin Kullanıcı</p>
            <p className="text-black dark:text-white text-3xl font-bold">
              {users.filter(u => u.role === 'admin').length}
            </p>
          </div>
          <div className="glass rounded-xl p-6">
            <p className="text-black dark:text-white text-sm mb-1">Aktif Kuponlar</p>
            <p className="text-black dark:text-white text-3xl font-bold">
              {users.reduce((sum, u) => sum + (u.coupons?.filter(c => !c.isUsed).length || 0), 0)}
            </p>
          </div>
          <div className="glass rounded-xl p-6">
            <p className="text-black dark:text-white text-sm mb-1">Toplam Favori</p>
            <p className="text-black dark:text-white text-3xl font-bold">
        ...
        <div className="glass rounded-2xl overflow-hidden">
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-white border-opacity-10">
                  <th className="text-left text-black dark:text-white font-semibold p-4">Kullanıcı</th>
                  <th className="text-left text-black dark:text-white font-semibold p-4">İletişim</th>
                  <th className="text-left text-black dark:text-white font-semibold p-4">Rol</th>
                  <th className="text-left text-black dark:text-white font-semibold p-4">Kuponlar</th>
                  <th className="text-left text-black dark:text-white font-semibold p-4">Kayıt Tarihi</th>
          ...
          {filteredUsers.length === 0 && (
            <div className="text-center py-20">
              <Users className="mx-auto mb-6 text-black dark:text-white" size={80} />
