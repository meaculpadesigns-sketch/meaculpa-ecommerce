      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <div className="space-y-8 text-gray-300">
            <section>
              <h2 className="text-2xl font-bold text-white mb-4">{t('returns.conditionsTitle')}</h2>
              <p className="mb-4">
            ...
            <section>
              <h2 className="text-2xl font-bold text-white mb-4">{t('returns.nonReturnableTitle')}</h2>
              <ul className="list-disc list-inside space-y-2 ml-4">
            ...
            <section>
              <h2 className="text-2xl font-bold text-white mb-4">{t('returns.processTitle')}</h2>
              <div className="space-y-4">
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="text-white font-semibold mb-2">{t('returns.processStep1Title')}</h3>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="text-white font-semibold mb-2">{t('returns.processStep2Title')}</h3>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="text-white font-semibold mb-2">{t('returns.processStep3Title')}</h3>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="text-white font-semibold mb-2">{t('returns.processStep4Title')}</h3>
            ...
            <section>
              <h2 className="text-2xl font-bold text-white mb-4">{t('returns.exchangeTitle')}</h2>
              <p className="mb-4">
            ...
            <section>
              <h2 className="text-2xl font-bold text-white mb-4">{t('returns.damagedTitle')}</h2>
              <p className="mb-4">
            ...
            <section>
              <h2 className="text-2xl font-bold text-white mb-4">{t('returns.shippingTitle')}</h2>
              <ul className="list-disc list-inside space-y-2 ml-4">
            ...
            <section>
              <h2 className="text-2xl font-bold text-white mb-4">{t('returns.contactTitle')}</h2>
              <p>
